...
const BottomQButton = ({ key, text, onClick }) => {
  return (
    <div
    ...
    >
      ...
      <div className="w-6 group-hover:w-12 h-full border-[1px] border-[#0D0D0D] border-r-0 rounded-md rounded-tr-none rounded-br-none relative duration-200">
      ...
      <div className="w-6 group-hover:w-12 h-full border-[1px] border-[#0D0D0D] border-l-0 rounded-md rounded-tl-none rounded-bl-none relative duration-200">
