...
const TopicbarRed = () => {
  const data = [
    16, 12, 16, 11, 29, 17, 23, 31, 4, 44, 25, 27, 26, 41, 66, 78, 16, 58, 33,
    20, 5, 49, 33, 26, 22, 46, 11, 19, 67, 53, 31, 4,
  ];
  ...
  return (
    <div
    className="flex space-x-3 items-end h-[600px]"
    >
      {
        <div
          style={{
