...
const Topicbar = () => {
  const data = [
    ...
    20, 5, 99, 73, 76, 22, 56, 11, 89, 67, 53, 31, 4,
  ];
...
{/* <div className="flex flex-row center">
  <div className="flex flex-col justify-start">
    <span className="text-base font-bold opacity-80">doğruluk</span>
    <span className="text-base font-bold opacity-80">tamamlama</span>
  </div>

  <div className="flex flex-col">
    <Topicbar />
    <div className=" w-[108%] h-[1px] bg-[#0d0d0d60] -translate-x-[8%]" />
