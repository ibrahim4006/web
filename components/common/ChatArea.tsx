...
const ChatArea = (props: Props) => {
  return (
    ...
    >
      <div
        key={"rakip"}
        className="h-[70px] relative top-0 frame-chat-top border-b flex flex-row items-center justify-between"
      >
      ...
      <div
        ...
        className="h-[798px] max-h-[798px]  relative top-0 flex flex-col "
      >
        <div
          key={"messages"}
          className=" h-[728px] max-h-[728px] w-full relative top-0 overflow-y-auto"
        >
        ...
        >
          <div key={"text area holder"} className="w-[93%] h-[55px] overflow-y-auto">
            <textarea
              placeholder="Mesaj gönder..."
              className="bg-[#F7F6F1] w-full h-full max-w-full resize-none focus:outline-none px-2 text-start items-center"
      ...
      <div
        key={"kullanıcı"}
        className="h-[70px] relative bottom-0 frame-chat-bottom border-t flex flex-row items-center justify-between"
      >
        <div className="flex flex-row">
          <div className="h-[44px] w-[34px] bg-gray-300 ml-3 left-0 " />
          <div className="flex flex-col relative ml-6 ">
